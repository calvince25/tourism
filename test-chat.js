...
var vectorStore_1 = require("./src/lib/ai/vectorStore");
var dotenv = require("dotenv");
dotenv.config({ path: '.env.local' });
var genAI = new generative_ai_1.GoogleGenerativeAI(process.env.GOOGLE_AI_API_KEY);
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var results, model, chat, result, _a, _b, _c, chunk, e_1_1, e_2;
        var _d, e_1, _e, _f;
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    _g.trys.push([0, 15, , 16]);
                    return [4 /*yield*/, (0, vectorStore_1.searchSimilar)('Kenya tours', 2)];
                case 1:
                    results = _g.sent();
                    ...
                    return [4 /*yield*/, chat.sendMessageStream('Hi')];
                case 2:
                    result = _g.sent();
                    _g.label = 3;
                case 3:
