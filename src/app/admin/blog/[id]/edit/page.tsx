        ...
        if (res.ok) {
          ...
          if (post) {
            ...
            if (post.featuredImage) {
              ...
              setCoverPreview(post.featuredImage.fileUrl);
            }
          }
        } else {
    ...
    <div className="space-y-10 max-w-5xl mx-auto pb-20">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-4xl font-bold font-outfit text-white mb-2">Edit Article</h1>
            <p className="text-white/40 text-sm">Update your professional story details.</p>
          </div>
        </div>
        <button
          type="button"
