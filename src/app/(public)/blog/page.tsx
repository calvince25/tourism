    ...
    <div className="min-h-screen bg-navy">
      ...
      <section className="relative min-h-[45vh] flex items-center justify-center overflow-hidden py-16 md:py-24">
        ...
        <div className="container mx-auto px-4 sm:px-8 relative z-20 text-center">
          <p className="text-accent uppercase tracking-widest font-bold mb-4 text-sm sm:text-base">Stories from the Wild</p>
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold font-outfit mb-6">Safari Blog</h1>
            ...
            <div className="space-y-24">
              ...
              {featuredPost && (
                <div className="group relative bg-navy-light/10 border border-white/5 rounded-[40px] overflow-hidden flex flex-col lg:flex-row hover:border-accent/30 transition-all duration-500">
                  ...
                  <div className="lg:w-2/5 p-6 sm:p-12 lg:p-20 flex flex-col justify-center">
                    <span className="text-accent uppercase tracking-widest font-bold text-xs mb-6">FEATURED STORY</span>
                    <h2 className="text-2xl sm:text-4xl lg:text-5xl font-bold font-outfit mb-6 text-white group-hover:text-accent transition-colors leading-tight">
                      {featuredPost.title}
                    </h2>
                    <p className="text-white/60 mb-10 text-base sm:text-lg leading-relaxed line-clamp-3">
